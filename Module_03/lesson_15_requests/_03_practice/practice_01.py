...
class WeatherAPI:
    ...
    def get_weather(self, city):
        ...
        try:
            ...
            print(f'Превышено время ожидания ответа от сервера (5 секунд).')
            return None
        except requests.exceptions.JSONDecodeError:
            print(f'Ошибка декодирования файла/Неверный формат файла.')
            return None
...
if __name__ == "__main__":
    ...
    if weather_data:
        ...
        weather_app.save_to_json(filename, weather_data)
    else:
